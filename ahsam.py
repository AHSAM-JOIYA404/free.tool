...
\033[41m\033[1;37mA TOOL BY AHSAM UL HAQ\x1b[0m
logo1 = """
\033[1;31m _______  _______    _______  
\033[1;33m (       )(  ____ )  (  ___  )|\     /||\     /|
\033[1;34m | () () || (    )|  | (   ) || )   ( || )   ( |
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print"Loading....."+ username #Dev: AHSAM
	    time.sleep(1)
            loop = 'false'
        else:
            print "\033[1;90mWrong "
            os.system('xdg-open https://youtube.com/@mrahsam82000')
    else:
        print "\033[1;90mWrong "
        os.system('xdg-open https://youtube.com/@mrahsam82000')
...
def pilih_login():
    ...
    time.sleep(0.05)
    jalan ('\033[1;97m◣0◢\x1b[1;96mTrickr Ahsam youtube channel')
    time.sleep(0.05)
    print 45*'█'
    action()
elif bch =="1":
